...
import TokenContractArtifactJson from '../contracts/target/token-Token.json' assert { type: 'json' };
...
export class TokenContract extends ContractBase {
  ...
  public methods!: {
    ...
    /** redeem_shield(to: struct, amount: field, note_counter: field, secret: field) */
    redeem_shield: ((to: AztecAddressLike, amount: FieldLike, note_counter: FieldLike, secret: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** note_counter() */
    note_counter: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** request_attestation(from: struct, attestor: struct, blacklist_root: field, proofs: array, nonce: field) */
    request_attestation: ((from: AztecAddressLike, attestor: AztecAddressLike, blacklist_root: FieldLike, proofs: FieldLike[], nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    /** privately_mint_private_note(amount: field, note_counter: field) */
    privately_mint_private_note: ((amount: FieldLike, note_counter: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
